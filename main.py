...
def recoveryScreen(key):
    ...
    lbl =  Label(window, text="Save this key to be able to recover the account")
    lbl.config(anchor=CENTER)
    lbl.pack()
    ...
    #         recoveryScreen()
    #     else:
    #         lbl1.config(text="Password do not match")
...
def resetScreen():
    ...
    lbl = Label(window, text="Enter the Recovery Kay")
    lbl.config(anchor=CENTER)
    lbl.pack()
